...
class TopRatedMoviePagingSource @Inject constructor(private val apiService: DataApiService, private var genreId:Int?) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ItemMovie> {
        return try {
            ...
            val response = apiService.topRatedMovieList(nextPageNumber)
